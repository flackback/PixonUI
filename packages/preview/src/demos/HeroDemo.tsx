  ...
  return (
    <div className="space-y-24 pb-24">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-white">Hero Templates</h2>
          <p className="text-white/50 mt-1">10+ modern layouts for high-impact landing pages.</p>
        </div>
      ...
      {/* 1. SaaS Split Hero */}
      <div key={`hero-saas-${key}`} className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[600px] p-8 md:p-16 rounded-3xl bg-zinc-950 border border-white/10 overflow-hidden">
        <Background variant="beams" noise patternColor="rgba(59, 130, 246, 0.1)" />
        <div className="relative z-10 space-y-8">
          <Badge variant="outline" className="bg-blue-500/10 border-blue-500/20 text-blue-400 px-4 py-1">
            New: Version 2.0 is here
          </Badge>
          <Heading as="h1" className="text-5xl md:text-6xl leading-tight">
            Scale your SaaS <TextGradient from="from-blue-400" to="to-indigo-500">faster</TextGradient> than ever.
          </Heading>
          <Text variant="lead">
        ...
        <div className="relative z-10 lg:translate-x-12">
          <Surface className="aspect-video bg-white/[0.02] border-white/10 shadow-2xl rotate-[-2deg] overflow-hidden p-0">
      ...
      {/* 2. Waitlist Hero */}
      <div key={`hero-waitlist-${key}`} className="relative flex flex-col items-center justify-center text-center min-h-[500px] p-8 rounded-3xl bg-black border border-white/5 overflow-hidden">
        <Background variant="mesh" animate className="opacity-30" />
        <div className="relative z-10 max-w-2xl space-y-8">
          <Badge className="bg-purple-500/20 text-purple-400 border-purple-500/30">Coming Soon</Badge>
          <Heading as="h1" className="text-4xl md:text-7xl font-extrabold tracking-tighter">
            Something big is <span className="italic text-purple-400">coming</span>.
          </Heading>
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto w-full">
            <input 
              className="flex-1 bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all" 
      ...
      <div key={`hero-mockup-${key}`} className="relative pt-24 pb-0 px-8 rounded-3xl bg-zinc-950 border border-white/10 overflow-hidden text-center">
        <Background variant="dots" mask="fade" patternColor="rgba(255,255,255,0.1)" />
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <Surface className="rounded-t-3xl border-b-0 bg-white/[0.03] backdrop-blur-2xl shadow-2xl p-0 overflow-hidden">
            ...
            <div className="aspect-[16/9] bg-gradient-to-br from-white/[0.02] to-transparent p-8">
              <div className="grid grid-cols-12 gap-6 h-full">
                ...
                <div className="col-span-9 bg-white/5 rounded-xl border border-white/5" />
              </div>
            </div>
          </Surface>
        </div>
      ...
      <div key={`hero-search-${key}`} className="relative min-h-[500px] flex flex-col items-center justify-center p-8 rounded-3xl bg-zinc-950 border border-white/10 overflow-hidden">
        <Background variant="grid" size={60} patternColor="rgba(255,255,255,0.03)" />
        <div className="relative z-10 w-full max-w-2xl space-y-10 text-center">
          ...
          <div className="relative group">
            ...
            <div className="relative flex items-center bg-black border border-white/10 rounded-2xl px-6 py-5 shadow-2xl">
              <Search className="w-6 h-6 text-white/40 mr-4" />
              <input 
                className="flex-1 bg-transparent text-xl text-white focus:outline-none placeholder:text-white/20" 
                placeholder="Search components..." 
              />
              <div className="flex items-center gap-1 ml-4">
                <kbd className="px-2 py-1 bg-white/10 rounded text-xs text-white/60 font-mono">⌘</kbd>
                <kbd className="px-2 py-1 bg-white/10 rounded text-xs text-white/60 font-mono">K</kbd>
              </div>
            </div>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {['Buttons', 'Cards', 'Modals', 'Charts', 'Forms'].map(tag => (
              <button key={tag} className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-sm text-white/60 hover:bg-white/10 transition-colors">
                {tag}
              </button>
            ))}
          </div>
      ...
      {/* 5. Feature-Led Hero */}
      <div key={`hero-features-${key}`} className="relative grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[600px] p-8 md:p-16 rounded-3xl bg-black border border-white/5 overflow-hidden">
        <Background variant="mesh" className="opacity-20" />
        <div className="relative z-10 space-y-8">
          <Heading as="h1" className="text-5xl md:text-6xl">Built for <span className="text-green-400">Performance</span>.</Heading>
          <Text variant="lead">PixonUI is optimized for speed, accessibility, and developer experience. No bloat, just pure code.</Text>
          <div className="space-y-4">
            {[
              { icon: <Zap className="text-yellow-400" />, title: 'Lightning Fast', desc: 'Optimized for 60fps animations.' },
              { icon: <Shield className="text-blue-400" />, title: 'Secure by Default', desc: 'Strict TypeScript and ARIA compliance.' },
              { icon: <Cpu className="text-purple-400" />, title: 'Lightweight', desc: 'Zero heavy external dependencies.' }
            ].map((feature, i) => (
        ...
        <div className="relative z-10 grid grid-cols-2 gap-4">
          <Surface className="aspect-square flex flex-col items-center justify-center p-8 text-center space-y-4 bg-white/[0.02] border-white/10">
            <div className="text-4xl font-bold text-white">99</div>
            <Text variant="muted" size="sm">Lighthouse Score</Text>
          </Surface>
          <Surface className="aspect-square flex flex-col items-center justify-center p-8 text-center space-y-4 mt-8 bg-white/[0.02] border-white/10">
            <div className="text-4xl font-bold text-white">0</div>
            <Text variant="muted" size="sm">Dependencies</Text>
          </Surface>
          <Surface className="aspect-square flex flex-col items-center justify-center p-8 text-center space-y-4 bg-white/[0.02] border-white/10">
            <div className="text-4xl font-bold text-white">12kb</div>
      ...
      {/* 6. Social Proof Hero */}
      <div key={`hero-social-${key}`} className="relative flex flex-col items-center justify-center text-center min-h-[600px] p-8 rounded-3xl bg-zinc-950 border border-white/10 overflow-hidden">
        <Background variant="dots" patternColor="rgba(255,255,255,0.05)" />
        <div className="relative z-10 max-w-3xl space-y-10">
          <div className="flex items-center justify-center -space-x-4">
            ...
            <div className="w-12 h-12 rounded-full border-4 border-zinc-950 bg-blue-600 flex items-center justify-center text-xs font-bold">
              +2k
            </div>
          </div>
          <Heading as="h1" className="text-5xl md:text-7xl font-bold">Loved by developers <br/> <span className="text-blue-500">worldwide</span>.</Heading>
      ...
      <div key={`hero-code-${key}`} className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[600px] p-8 md:p-16 rounded-3xl bg-[#050505] border border-white/5 overflow-hidden">
        <Background variant="grid" size={30} patternColor="rgba(255,255,255,0.02)" />
        <div className="relative z-10 space-y-8">
          ...
          <div className="flex gap-4">
            <Button size="lg" className="rounded-xl px-8 bg-white text-black hover:bg-white/90">Read Docs</Button>
            <Button variant="outline" size="lg" className="rounded-xl px-8 border-white/10 hover:bg-white/5">
              <Github className="w-4 h-4 mr-2" /> GitHub
            </Button>
          </div>
        </div>
        <div className="relative z-10">
          <Surface className="bg-[#0D0D0D] border-white/10 p-0 overflow-hidden shadow-2xl">
            <div className="h-10 border-b border-white/5 bg-white/5 flex items-center px-4 justify-between">
              ...
              <div className="text-[10px] text-white/20 font-mono uppercase tracking-widest">Button.tsx</div>
              <div className="w-12" />
            </div>
            <div className="p-6 font-mono text-sm leading-relaxed">
              ...
              <div className="text-purple-400">import <span className="text-white">{`{ cn }`}</span> from <span className="text-green-400">'../../utils/cn'</span>;</div>
              <div className="mt-4 text-purple-400">export const <span className="text-blue-400">Button</span> = ({`{ children, className }`}) ={`>`} (</div>
              <div className="pl-4 text-white">
                {`<button`}
                <div className="pl-4 text-purple-400">
                  className={<span className="text-green-400">{`cn(`}</span>}
      ...
      {/* 8. Announcement Hero */}
      <div key={`hero-announcement-${key}`} className="relative flex flex-col items-center justify-center text-center min-h-[500px] p-8 rounded-3xl bg-zinc-950 border border-white/10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl space-y-8">
          ...
          <Heading as="h1" className="text-5xl md:text-8xl font-black tracking-tighter uppercase">
            PixonUI <span className="text-yellow-500">v3.0</span>
          </Heading>
          <Text variant="lead" className="max-w-xl mx-auto">
      ...
      <div key={`hero-mobile-${key}`} className="relative pt-24 pb-0 px-8 rounded-3xl bg-black border border-white/5 overflow-hidden text-center">
        <Background variant="mesh" className="opacity-30" />
        <div className="relative z-10 max-w-2xl mx-auto space-y-8 mb-16">
          <Heading as="h1" className="text-5xl md:text-7xl font-bold">Your app, <br/> <ShinyText shimmerColor="rgba(255,255,255,0.8)">everywhere</ShinyText>.</Heading>
        ...
        <div className="flex items-end justify-center gap-8 max-w-4xl mx-auto">
          <div className="w-64 h-[450px] rounded-[3rem] border-8 border-zinc-900 bg-zinc-950 shadow-2xl overflow-hidden translate-y-12 rotate-[-5deg]">
            <div className="h-6 w-24 bg-zinc-900 mx-auto rounded-b-2xl" />
            <div className="p-6 space-y-6">
          ...
          <div className="w-64 h-[500px] rounded-[3rem] border-8 border-zinc-900 bg-zinc-950 shadow-2xl overflow-hidden z-10">
            <div className="h-6 w-24 bg-zinc-900 mx-auto rounded-b-2xl" />
            <div className="p-6 space-y-8">
              ...
              <div className="h-48 w-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl border border-white/5" />
      ...
      <div key={`hero-glass-${key}`} className="relative min-h-[700px] flex items-center justify-center p-8 rounded-3xl bg-zinc-950 border border-white/10 overflow-hidden">
        <Background variant="grid" size={50} patternColor="rgba(255,255,255,0.05)" />
        ...
        <Surface className="relative z-10 max-w-4xl w-full p-12 md:p-20 bg-white/[0.01] backdrop-blur-3xl border-white/10 shadow-2xl text-center space-y-10">
          <div className="space-y-6">
            <Heading as="h1" className="text-5xl md:text-7xl font-bold tracking-tight">
              The <span className="text-blue-400">Glassmorphic</span> <br/> Revolution.
            </Heading>
          ...
          <div className="pt-10 flex items-center justify-center gap-8 text-white/30">
