...
const steps = [
  {
    ...
    args: [
      ...
      'src/__tests__/motion.revealOnScroll.test.tsx',
  ...
  },
  {
    ...
    args: [
      ...
      'e2e/motion-advanced.spec.ts',
      '--project=chromium',
      '--workers=1',
    ],
  },
  {
    name: 'Motion performance budget E2E (chromium)',
    cmd: 'pnpm',
    args: [
      'exec',
      'playwright',
      'test',
      'e2e/motion-performance-budget.spec.ts',
      '--project=chromium',
      '--workers=1',
    ],
  },
