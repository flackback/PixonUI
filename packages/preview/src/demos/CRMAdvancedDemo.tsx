...
export function CRMAdvancedDemo() {
  ...
  return (
    <div className="space-y-8 pb-20">
          ...
          <Card className="p-4 space-y-4">
            ...
            <MessageBubble 
              message={{
                id: '2',
                remoteJid: 'crm',
                content: 'CLIENTE VIP: Priorizar atendimento e oferecer desconto de 10%.',
                senderId: 'me',
                timestamp: new Date(),
                status: 'read',
                isInternalNote: true,
      ...
      <section>
        <Heading as="h3" className="mb-4">AI Intelligence</Heading>
        <div className="space-y-4">
          ...
          <div className="p-4 border border-zinc-200/70 dark:border-white/5 rounded-2xl bg-white/60 dark:bg-white/[0.02]">
            ...
            <SmartReplySuggestions 
              ...
              onSelect={(s: string) => alert('Selecionado: ' + s)}
            />
          </div>
        </div>
      </section>
