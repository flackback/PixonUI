  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-12">
      ...
      <div className="flex flex-col gap-2">
        ...
        <h2 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-white via-zinc-200 to-zinc-500 bg-clip-text text-transparent">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
              ...
              {SAMPLE_VIDEOS.map((video) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-[10px] font-bold text-cyan-400 flex items-center gap-1.5 mt-2">
        ...
        <div className="space-y-6">
          ...
          {/* Quick Config panel */}
          <Card className="p-5 border-white/10 bg-glass backdrop-blur-md space-y-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] cursor-pointer transition-all">
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-white">Cinema Ambient Glow</span>
                  <span className="text-[10px] text-zinc-400">Projeção difusa de cores em tempo real via GPU</span>
                </div>
                <input
                  type="checkbox"
                  checked={ambientGlow}
                  onChange={(e) => setAmbientGlow(e.target.checked)}
                  className="rounded border-white/10 text-cyan-500 focus:ring-cyan-500 bg-zinc-900 h-4 w-4"
                />
              </label>

              <div className="p-3 rounded-xl bg-white/[0.01] border border-white/5 text-[10px] text-zinc-400 leading-relaxed space-y-1">
                <span className="font-bold text-white text-[11px] block">💡 Dica de Engenharia:</span>
          ...
          <Card className="p-5 border-white/10 bg-glass backdrop-blur-md space-y-4">
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={i} className="flex items-center justify-between text-xs py-1.5 border-b border-white/5 last:border-none">
                  <span className="text-zinc-400 text-[11px]">{shortcut.label}</span>
                  <div className="flex gap-1">
                    {shortcut.keys.map((k) => (
                      <kbd key={k} className="px-1.5 py-0.5 rounded-md bg-white/10 border border-white/10 text-[10px] font-bold text-white shadow">
                        {k}
                      </kbd>
                    ))}
                  </div>
          ...
          <Card className="p-5 border-white/10 bg-glass backdrop-blur-md space-y-3.5">
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <div className="space-y-0.5">
                  <h4 className="text-xs font-bold text-white">In-App Miniplayer</h4>
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-0.5">
                  <h4 className="text-xs font-bold text-white">Gestos de Toque Duplo</h4>
                  <p className="text-[10px] text-zinc-400 leading-relaxed">
