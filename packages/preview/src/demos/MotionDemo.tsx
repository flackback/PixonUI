...
import { Motion, MotionGroup, TextMotion, Parallax, Surface, Button } from '@pixonui/react';
      ...
      <div className="space-y-4 pt-12">
        ...
        <div className="space-y-24 pb-24">
          {[1, 2, 3].map((i) => (
            ...
            >
              <Surface className="w-full max-w-md p-12 text-center border-primary/20 bg-primary/5">
                <span className="text-4xl font-bold text-primary">Section {i}</span>
