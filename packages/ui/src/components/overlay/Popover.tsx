...
export function PopoverContent({ className, children, align = 'center', sideOffset = 4, ...props }: PopoverContentProps) {
  ...
  return createPortal(
    <div
      ...
      className={cn(
        "fixed z-[110] min-w-[12rem] rounded-2xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl p-4 shadow-xl outline-none transition duration-200",
